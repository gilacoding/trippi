-- MARKICAB P0.4 — Wishlist Group Flow
-- New table: wishlist_items (separate from agenda items)
-- No PostGIS — uses simple lat/lng floats
...
-- 3b. convert_wishlist_to_itinerary (OWNER ONLY)
...
begin
  ...
  -- Link wishlist to agenda (preserve history)
